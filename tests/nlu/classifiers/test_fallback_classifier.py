...
from rasa.nlu.training_data.message import (
    INTENT_RANKING_KEY,
    INTENT_KEY,
...
def test_predict_fallback_intent():
    ...
    message = Message(
        "some message",
        data={
            INTENT_KEY: {"name": "greet", INTENT_CONFIDENCE_KEY: 0.234891876578331},
            INTENT_RANKING_KEY: [
    ...
    assert message.data[INTENT_KEY] == expected_intent
...
def test_not_predict_fallback_intent():
    ...
    message = Message(
        ...
        data={
            ...
            INTENT_RANKING_KEY: [
                {"name": "greet", INTENT_CONFIDENCE_KEY: 0.234891876578331},
                {"name": "stop", INTENT_CONFIDENCE_KEY: threshold},
                {"name": "affirm", INTENT_CONFIDENCE_KEY: 0},
                {"name": "inform", INTENT_CONFIDENCE_KEY: -100},
                {"name": "deny", INTENT_CONFIDENCE_KEY: 0.0879683718085289},
            ],
